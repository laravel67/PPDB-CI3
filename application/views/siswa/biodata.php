  ...
  <div class="content">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="panel panel-flat">
          <div class="panel-body">
            <center>
              <img src="<?= base_url('img/photo/' . $user->photo); ?>" alt="<?php echo $user->nama_lengkap; ?>" class="" width="176">
            </center>
            <br>
            <fieldset class="content-group">
    ...
    <div class="col-md-4">
      <div class="panel panel-flat">
        <div class="panel-body">
          <fieldset class="content-group">
            <legend class="text-bold"><i class="icon-book"></i> IJAZAH</legend>
            <div class="table-responsive">
              <img src="<?= base_url('/img/ijazah/' . $user->ijazah); ?>" style="width: 100%; height:400px">
            </div>
          </fieldset>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="panel panel-flat">
        <div class="panel-body">
          <fieldset class="content-group">
            <legend class="text-bold"><i class="icon-book"></i> Kartu Keluarga</legend>
            <div class="table-responsive">
              <img src="<?= base_url('/img/kk/' . $user->kk); ?>" style="width: 100%; height:400px">
            </div>
          </fieldset>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="panel panel-flat">
        <div class="panel-body">
          <fieldset class="content-group">
            <legend class="text-bold"><i class="icon-book"></i> SKHU</legend>
            <div class="table-responsive">
              <img src="<?= base_url('/img/skhu/' . $user->skhu); ?>" style="width: 100%; height:400px">
            </div>
          </fieldset>
        </div>
      </div>
