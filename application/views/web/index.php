...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    ...
                    <span style="margin-left:45px;">&nbsp;PSB Online</span>
                </a>
            </div>
    ...
    <header>
        <?php
        // Memeriksa apakah segment pertama dari URI adalah 'logcs' sebelum memuat view login
        if ($this->uri->segment(1) && strtolower($this->uri->segment(1)) == 'logcs') {
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify; line-height: 22px;">
                    <p><?php echo $user['nama_lengkap']; ?> menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                        dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru di masa sekarang sangat mudah di karenakn adanya PPDB online ini bisa mengakses website PPDB Online dari <?php echo $user['nama_lengkap']; ?>. </p>
                </div>
